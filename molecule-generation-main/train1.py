...
if __name__ == "__main__":
    ...
    train_df = pd.read_csv('train_prop.csv')
    train_dataset = MoleculeDataset(train_df, 'smiles', 'smiles')
    print(train_df.loc[1], train_dataset[1])
    print(train_dataset.source_vocab.itos,
          train_dataset.source_vocab.stoi)

    valid_df = pd.read_csv('valid_prop.csv')
    valid_dataset = MoleculeDataset(valid_df, 'smiles', 'smiles')
